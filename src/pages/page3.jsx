...
export default function HotelRoomPageThree() {
    return (
        <>
      <SEO
        title="King Room – Disability Access"
        description="Accessible King Room at Crossroads Inn Hotel Fort Pierce FL. Fully equipped for guests with disabilities. 28 sqm, king bed, roll-in shower, free WiFi. From $113.30/night."
        keywords="accessible hotel room Fort Pierce, disability access hotel Florida, ADA hotel room Fort Pierce"
        canonical="/page3"
      />
            {/* Image Gallery */}
            <div className="hotel-room-image-gallery">
                <div className="hotel-room-gallery-container">
                    <div className="hotel-room-gallery-item">
                        <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/841166359.jpg?k=51553a626694d8c80b8dc6cb68044d2170840e96847d1043516b133d8472bb83&o=" alt="Luxury hotel bed" width="1024" height="768" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/841166090.jpg?k=4003251f3dc861555e260a33b04265a7d5f101e4a70f2ba16f201b4d3c391b33&o=" alt="Modern hotel room bed" width="1024" height="768" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src={image4} alt="King size bed room" width="800" height="600" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/841166708.jpg?k=8ec271085a6a5350f94bbfa28a700f96a2069bcee1d5bf0fa7936bbf1207af0f&o=" alt="Premium hotel bedroom" width="1024" height="768" loading="lazy" />
                    </div>
                </div>
            ...
            <div className="hotel-room-details-section">
                <div className="hotel-room-header-container">
                    <div className="hotel-room-info-block">
                        <h1 className="hotel-room-title-text">King Room (Disability Access)</h1>
