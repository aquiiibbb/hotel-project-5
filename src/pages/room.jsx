...
import image7 from "../Assets/db1.webp";
import image8 from "../Assets/doubleking.webp";
import image9 from "../Assets/dba.webp";
import image10 from "../Assets/6.webp";
import image11 from "../Assets/db4.webp";
...
export default function Room() {
  ...
  return (
    <>
      <SEO
        title="Rooms & Rates"
        description="Browse all room types at Crossroads Inn Hotel – King Bed, Double Room, King Room with Disability Access and more. Starting from $109/night. Book direct for the best price."
        keywords="hotel rooms Fort Pierce, king bed room Florida, double room hotel, disability access room, hotel rates Fort Pierce FL"
        canonical="/room"
      />
      {/* Hero Section */}
              ...
              <div key={room.id} className="room-card">
                <div className="room-image-container">
                  <img
                    ...
                    onClick={() => handleRoomClick(room.id)} loading="lazy"
        ...
        <div className="room-comfort-container">
          <div className="room-comfort-image">
            <img
              ...
              className="comfort-image" width="800" height="600" loading="lazy" />
          ...
          <div className="room-comfort-content">
            ...
            <div className="comfort-description">
              ...
              <p className="comfort-text">
                Whether you're visiting for business, working locally, or exploring Fort Pierce, our
