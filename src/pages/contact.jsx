...
export default function Contact() {
  return (
    <>
      <SEO
        title="Contact Us"
        description="Contact Crossroads Inn Hotel at 7050 Okeechobee Rd, Fort Pierce, FL 34945. Call +17724658600. Check-in from 15:00, check-out until 11:00."
        keywords="contact Crossroads Inn Hotel, hotel address Fort Pierce, hotel phone number, Fort Pierce FL hotel contact"
        canonical="/contact"
      />
      {/* Hero Section */}
