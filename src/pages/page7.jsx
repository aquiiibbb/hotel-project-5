import './page1.css'
import image10 from "../Assets/6.webp";
import image11 from "../Assets/4.webp";
import image12 from "../Assets/bathroom.webp";
...
export default function HotelRoomPageSeven() {
    return (
      ...
      <SEO
        ...
        description="Superior King Room at Crossroads Inn Hotel Fort Pierce FL. Premium king bed, elegant decor, free WiFi, air conditioning, flat-screen TV and en-suite bathroom."
        keywords="superior king room Fort Pierce, premium hotel room Florida, upgraded hotel room Fort Pierce"
        canonical="/page7"
      />
            {/* Image Gallery */}
            <div className="hotel-room-image-gallery">
                <div className="hotel-room-gallery-container">
                    ...
                    <img src={image10} alt="Luxury hotel twin beds interior" width="800" height="600" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src={image11}  alt="Modern hotel bedroom lighting" width="800" height="600" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src={image12}  alt="Hotel desk and seating area" width="800" height="600" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/841166709.jpg?k=5561a1839f9f1315f6252e7474dd2e1e7da91c2cd204f53a81fb73a8b1f0561d&o=" alt="Elegant hotel bathroom interior" width="1024" height="768" loading="lazy" />
                    </div>
                </div>
