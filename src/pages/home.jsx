...
export default function Home() {
   ...
   return (
      ...
      <SEO
        ...
        description="Crossroads Inn Hotel in Fort Pierce, FL offers comfortable king, double and accessible rooms. Enjoy free WiFi, parking and warm hospitality. Book now for best rates."
        keywords="Crossroads Inn Hotel, hotel Fort Pierce FL, hotel near Fort Pierce, affordable hotel Florida, king bed hotel, double room hotel"
        canonical="/"
      />
            ...
            <div className="container">
               <div className="hotel-info-content">
                  <div className="hotel-image">
                     <img
                        src={image10}
                        alt="Crossroads Inn Hotel – Fort Pierce FL exterior view" width="800" height="600" loading="lazy" />
                  </div>
                     ...
                     <div key={room.id} className="room-card">
                        <div className="room-image-container">
                           <img
                              ...
                              onClick={() => navigate(`/page${room.id}`)} loading="lazy"
