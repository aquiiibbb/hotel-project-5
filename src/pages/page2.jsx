...
export default function HotelRoomPageThree() {
    return (
        <>
      <SEO
        title="Double Room – 2 Beds"
        description="Double Room with 2 beds at Crossroads Inn Hotel Fort Pierce FL. 28 sqm, perfect for families or groups. Free WiFi, air conditioning, private bathroom. From $109.99/night."
        keywords="double room Fort Pierce, two bed hotel room Florida, family room hotel Fort Pierce"
        canonical="/page2"
      />
            {/* Image Gallery */}
            <div className="hotel-room-image-gallery">
                <div className="hotel-room-gallery-container">
                    <div className="hotel-room-gallery-item">
                        <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/841167377.jpg?k=6e76f042b8b2bc6a7039bcbef3d080d8b4545b4fed97849a4b90b436b5a3db64&o=" alt="Luxury hotel bed" width="1024" height="768" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src={image5} alt="Modern hotel room bed" width="800" height="600" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/841167744.jpg?k=08eb06acf04fc443588b0f1d28f5536c9cff4fcc2ad0519d0b37decb57d37baf&o=" alt="King size bed room" width="1024" height="768" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src="https://cf.bstatic.com/xdata/images/hotel/max1024x768/841168151.jpg?k=01e93358bcccd0ea880aca3a9ef193b6d4b383e5cd246c268275900c7ddf9d6b&o=" alt="Premium hotel bedroom" width="1024" height="768" loading="lazy" />
                    </div>
                </div>
