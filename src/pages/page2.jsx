...
export default function HotelRoomPageTwo() {
    return (
        <>
            ...
            <div className="hotel-room-two-details-section">
                <div className="hotel-room-two-header-container">
                    <div className="hotel-room-two-info-block">
                        <h1 className="hotel-room-two-title-text">Twin Room</h1>
                        <div className="hotel-room-two-price-info-container">
                            <span className="hotel-room-two-price-label">From</span>
                            <span className="hotel-room-two-price-amount">£104.50</span>
                            <span className="hotel-room-two-price-period">Per Night</span>
                        </div>
                    </div>

                    <div className="hotel-room-two-features-container">
                        <div className="hotel-room-two-feature-item">
                            <div className="hotel-room-two-feature-icon-wrapper">
                ...
                <div className="hotel-room-two-action-buttons-container">
                    <button className="hotel-room-two-action-btn">
            ...
            {/* Main Content */}
            <div className="hotel-room-two-main-content-wrapper">
                <div className="hotel-room-two-content-left-section">
                    <section className="hotel-room-two-overview-section">
                        <h2 className="hotel-room-two-section-title">Overview</h2>
                        <p className="hotel-room-two-overview-text">
                    ...
                    <section className="hotel-room-two-amenities-section">
                        <h2 className="hotel-room-two-section-title">Room Amenities</h2>
                        <div className="hotel-room-two-amenities-grid">
                            <div className="hotel-room-two-amenity-item">
                                <div className="hotel-room-two-amenity-icon">
                                ...
                                <span className="hotel-room-two-amenity-text">Complimentary toiletries</span>
                            </div>
                            ...
                            <div className="hotel-room-two-amenity-item">
                                ...
                                <span className="hotel-room-two-amenity-text">Flat-screen TV</span>
                            </div>
                            ...
                            <div className="hotel-room-two-amenity-item">
                                ...
                                <span className="hotel-room-two-amenity-text">Free Wi-Fi</span>
                            </div>
                            ...
                            <div className="hotel-room-two-amenity-item">
                                ...
                                <span className="hotel-room-two-amenity-text">Fresh towels</span>
                            </div>
                            ...
                            <div className="hotel-room-two-amenity-item">
                                ...
                                <span className="hotel-room-two-amenity-text">Tea and coffee making facilities</span>
                            </div>
                        </div>
                    </section>

                    <section className="hotel-room-two-booking-rules-section">
                        <h2 className="hotel-room-two-section-title">Booking Rules</h2>
                        <div className="hotel-room-two-booking-rules-grid">
                            <div className="hotel-room-two-rules-column">
                                <h3 className="hotel-room-two-rules-subtitle">Check-In Rules</h3>
                                <p className="hotel-room-two-rules-text">From 14:00</p>
                                <p className="hotel-room-two-rules-text">Guests are required to show a photo identification and credit card upon check-in</p>
                                <p className="hotel-room-two-rules-text">You'll need to let the property know in advance what time you'll arrive.</p>
                            </div>
                            <div className="hotel-room-two-rules-column">
                                <h3 className="hotel-room-two-rules-subtitle">Check-Out Rules</h3>
                                <p className="hotel-room-two-rules-text">Until 10:00</p>
                            </div>
                        </div>
                    </section>
                </div>

                <div className="hotel-room-two-content-right-section">
                    <a
                        href="https://bookingengine.stayflexi.com/?hotel_id=35135"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="hotel-room-two-book-now-btn"
                    ...
                    <div className="hotel-room-two-last-minute-deals">
                        ...
                        <div className="hotel-room-two-deal-item">
                            ...
                            <div className="hotel-room-two-deal-info">
                                <h4 className="hotel-room-two-deal-name">Honeymoon Suite</h4>
                                <div className="hotel-room-two-deal-price">
                                    <span className="hotel-room-two-current-price">From £267.30</span>
                                    <span className="hotel-room-two-original-price">£267.30</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="hotel-room-two-deal-item">
                            ...
                            <div className="hotel-room-two-deal-info">
                                <h4 className="hotel-room-two-deal-name">Family Suite</h4>
                                <div className="hotel-room-two-deal-price">
                                    <span className="hotel-room-two-current-price">From £177.10</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="hotel-room-two-deal-item">
                            ...
                            <div className="hotel-room-two-deal-info">
                                <h4 className="hotel-room-two-deal-name">Deluxe Superking Room</h4>
                                <div className="hotel-room-two-deal-price">
                        ...
                        <div className="hotel-room-two-deal-item">
                            ...
                            <div className="hotel-room-two-deal-info">
                                <h4 className="hotel-room-two-deal-name">Double Room</h4>
                                <div className="hotel-room-two-deal-price">
                                    <span className="hotel-room-two-current-price">From £113.30</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="hotel-room-two-breakfast-promo">
                        <img src="https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?w=300&h=200&fit=crop" alt="Continental Breakfast" className="hotel-room-two-promo-image" />
                        <div className="hotel-room-two-promo-content">
                            <p className="hotel-room-two-promo-subtitle">Start Your Day Right</p>
                            <h3 className="hotel-room-two-promo-title">Self-Serve Continental Breakfast</h3>
                        </div>
                    </div>
                </div>
            </div>
