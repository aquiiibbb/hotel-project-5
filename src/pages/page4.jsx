import './page1.css'
import image8 from "../Assets/db1.webp";
import image9 from "../Assets/db2.webp";
import image10 from "../Assets/db3.webp";
import image11 from "../Assets/anotherside.webp";
...
export default function HotelRoomPageFour() {
    return (
        <>
      <SEO
        title="Double King Room"
        description="Double King Room at Crossroads Inn Hotel Fort Pierce FL. Luxurious room with king-size bed setup, modern decor, free WiFi and all standard amenities. Book today."
        keywords="double king room Fort Pierce, king hotel room Florida, luxury hotel room Fort Pierce"
        canonical="/page4"
      />
            {/* Image Gallery */}
            <div className="hotel-room-image-gallery">
                <div className="hotel-room-gallery-container">
                    <div className="hotel-room-gallery-item">
                        <img src={image8} alt="Elegant hotel twin beds" width="800" height="600" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src={image9} alt="Cozy hotel bedroom" width="800" height="600" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src={image10} alt="Hotel room with workspace" width="800" height="600" loading="lazy" />
                    </div>
                    <div className="hotel-room-gallery-item">
                        <img src={image11} alt="Modern hotel bathroom" width="800" height="600" loading="lazy" />
                    </div>
                </div>
